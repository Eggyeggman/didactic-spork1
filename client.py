...
def openChatWindow():
    ...
    textarea=Text(window,width=67,height=60,font=("calibri",10))
    ...
    text_message = Entry(window,width=40,font=("calibri",10))
    text_message.pack()
    text_message.place(x=100,y=305)
    attach = Button(window,text ="attach & send",font=("calibri",10))
